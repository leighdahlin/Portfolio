...
viewPortfolio.addEventListener("click", function(){
    ...
    aboutMeCard.setAttribute("style","height: 55%; width: 100%; transition-property: transform; transition-duration: 600ms; transform: translate(0%)");
...
//     insert code to lead back to initial page
// })